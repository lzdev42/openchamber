...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "pwa.installPrompt.description": "Instale o Ocelot para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "Ocelot instalado",
  ...
  "mobile.connect.welcome.title": "Conectar ao Ocelot",
  ...
  "mobile.connect.password.placeholder": "Senha do Ocelot",
  ...
  "mobile.connect.scan.invalid": "Esse código QR não é um código de conexão do Ocelot.",
  ...
  "mobile.connect.error.unreachable": "Não foi possível acessar esse servidor Ocelot.",
  ...
  "sessions.sidebar.footer.actions.aboutOcelot": "Sobre o Ocelot",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao Ocelot — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "header.services.shutdownDev": "Parar Ocelot",
  ...
  "terminalView.bottomDock.cdToConfigDirTitle": "Ir para o diretório de configuração do opencode",
  "terminalView.bottomDock.cdToConfigDirAria": "Ir para o diretório de configuração do opencode",
  ...
  "aboutDialog.openChamberVersionLabel": "Versão do Ocelot {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do Ocelot, a integridade do OpenCode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo Ocelot com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do Ocelot",
  "header.actions.openAppMenuAria": "Abrir menu do Ocelot",
  ...
  "chat.workingStatus.composing": "Compondo",
  "chat.workingStatus.editingFile": "Editando arquivo",
  "chat.workingStatus.waitingForPermission": "Aguardando permissão",
  "chat.workingStatus.usingTool": "Usando {tool}",
  "chat.workingStatus.tool.read": "Lendo arquivo",
  "chat.workingStatus.tool.write": "Escrevendo arquivo",
  "chat.workingStatus.tool.edit": "Editando arquivo",
  "chat.workingStatus.tool.multiedit": "Editando arquivos",
  "chat.workingStatus.tool.apply_patch": "Aplicando patch",
  "chat.workingStatus.tool.bash": "Executando comando",
  "chat.workingStatus.tool.grep": "Buscando conteúdo",
  "chat.workingStatus.tool.glob": "Localizando arquivos",
  "chat.workingStatus.tool.list": "Listando diretório",
  "chat.workingStatus.tool.task": "Delegando tarefa",
  "chat.workingStatus.tool.webfetch": "Obtendo URL",
  "chat.workingStatus.tool.websearch": "Pesquisando na web",
  "chat.workingStatus.tool.codesearch": "Busca de código na web",
  "chat.workingStatus.tool.todowrite": "Atualizando tarefas",
  "chat.workingStatus.tool.todoread": "Lendo tarefas",
  "chat.workingStatus.tool.skill": "Aprendendo habilidade",
  "chat.workingStatus.tool.question": "Fazendo pergunta",
  "chat.workingStatus.tool.plan_enter": "Mudando para planejamento",
  "chat.workingStatus.tool.plan_exit": "Mudando para construção",
  "chat.workingStatus.generic.working": "Trabalhando",
  "chat.workingStatus.generic.processing": "Processando",
  "chat.workingStatus.generic.preparing": "Preparando",
  "chat.workingStatus.generic.warmingUp": "Aquecendo",
  "chat.workingStatus.generic.gearsTurning": "Engrenagens girando",
  "chat.workingStatus.generic.computing": "Computando",
  "chat.workingStatus.generic.calculating": "Calculando",
  "chat.workingStatus.generic.analyzing": "Analisando",
  "chat.workingStatus.generic.wheelsSpinning": "Rodas girando",
  "chat.workingStatus.generic.calibrating": "Calibrando",
  "chat.workingStatus.generic.synthesizing": "Sintetizando",
  "chat.workingStatus.generic.connectingDots": "Conectando pontos",
  "chat.workingStatus.generic.inspectingLogic": "Inspecionando lógica",
  "chat.workingStatus.generic.weighingOptions": "Avaliando opções",
  "chat.workingStatus.retrying": "Retentando",
  "chat.workingStatus.retryingIn": "Retentando em {countdown}",
  "chat.workingStatus.retryingAttempt": "Retentando (tentativa {attempt})",
  "chat.workingStatus.retryingInAttempt": "Retentando em {countdown} (tentativa {attempt})",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do Ocelot",
  ...
  "multiRun.window.description": "Janela do Ocelot Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao Ocelot",
  ...
  "onboarding.chooser.tabs.bundled": "Embutido",
  "onboarding.chooser.bundled.title": "Usar OpenCode embutido",
  "onboarding.chooser.bundled.description": "Usar o CLI OpenCode embutido com OpenChamber Desktop. Não requer instalação separada.",
  "onboarding.chooser.bundled.notDetectedHint": "CLI embutido não disponível nesta compilação.",
  "onboarding.chooser.bundled.actions.useBundled": "Usar versão integrada",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o Ocelot não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do Ocelot. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do Ocelot e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do Ocelot para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor Ocelot ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do Ocelot. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando Ocelot, mas não é compatível com esta versão do app. Atualize o Ocelot no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando Ocelot. Verifique se o endereço aponta para um servidor Ocelot.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando Ocelot. Verifique se o endereço aponta para um servidor Ocelot.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor Ocelot em \"{host}\" não é compatível com esta versão do app. Atualize o Ocelot no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O Ocelot não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando Ocelot...",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantenha o Ocelot aberto.",
  ...
  "openChamberLogo.aria.logo": "Logo do Ocelot",
