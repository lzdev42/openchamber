...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.connect.welcome.title': '連線至 Ocelot',
  ...
  'mobile.connect.password.placeholder': 'Ocelot 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 Ocelot 連線代碼。',
  ...
  'mobile.connect.error.unreachable': '無法連線至該 Ocelot 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 Ocelot。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 Ocelot，但與此應用程式版本不相容。請更新伺服器上的 Ocelot 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 Ocelot 伺服器與此應用程式版本不相容。請更新伺服器上的 Ocelot 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutOcelot': '關於 Ocelot',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 Ocelot 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'header.services.shutdownDev': '停止 Ocelot',
  ...
  'terminalView.bottomDock.cdToConfigDirTitle': '前往 opencode 設定目錄',
  'terminalView.bottomDock.cdToConfigDirAria': '前往 opencode 設定目錄',
  ...
  'aboutDialog.openChamberVersionLabel': 'Ocelot 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Ocelot 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 Ocelot',
  ...
  'header.actions.openAppMenu': 'Ocelot 選單',
  'header.actions.openAppMenuAria': '開啟 Ocelot 選單',
  ...
  'chat.workingStatus.composing': '撰寫中',
  'chat.workingStatus.editingFile': '編輯檔案中',
  'chat.workingStatus.waitingForPermission': '等待權限',
  'chat.workingStatus.usingTool': '使用 {tool} 中',
  'chat.workingStatus.tool.read': '讀取檔案中',
  'chat.workingStatus.tool.write': '寫入檔案中',
  'chat.workingStatus.tool.edit': '編輯檔案中',
  'chat.workingStatus.tool.multiedit': '編輯多個檔案中',
  'chat.workingStatus.tool.apply_patch': '套用補丁中',
  'chat.workingStatus.tool.bash': '執行命令中',
  'chat.workingStatus.tool.grep': '搜尋內容中',
  'chat.workingStatus.tool.glob': '尋找檔案中',
  'chat.workingStatus.tool.list': '列出目錄中',
  'chat.workingStatus.tool.task': '委派任務中',
  'chat.workingStatus.tool.webfetch': '擷取 URL 中',
  'chat.workingStatus.tool.websearch': '搜尋網頁中',
  'chat.workingStatus.tool.codesearch': '網頁程式碼搜尋中',
  'chat.workingStatus.tool.todowrite': '更新待辦中',
  'chat.workingStatus.tool.todoread': '讀取待辦中',
  'chat.workingStatus.tool.skill': '學習技能中',
  'chat.workingStatus.tool.question': '提問中',
  'chat.workingStatus.tool.plan_enter': '切換到規劃中',
  'chat.workingStatus.tool.plan_exit': '切換到建置中',
  'chat.workingStatus.generic.working': '處理中',
  'chat.workingStatus.generic.processing': '處理中',
  'chat.workingStatus.generic.preparing': '準備中',
  'chat.workingStatus.generic.warmingUp': '預熱中',
  'chat.workingStatus.generic.gearsTurning': '齒輪轉動中',
  'chat.workingStatus.generic.computing': '計算中',
  'chat.workingStatus.generic.calculating': '運算中',
  'chat.workingStatus.generic.analyzing': '分析中',
  'chat.workingStatus.generic.wheelsSpinning': '轉輪轉動中',
  'chat.workingStatus.generic.calibrating': '校準中',
  'chat.workingStatus.generic.synthesizing': '綜合中',
  'chat.workingStatus.generic.connectingDots': '連點成線中',
  'chat.workingStatus.generic.inspectingLogic': '檢查邏輯中',
  'chat.workingStatus.generic.weighingOptions': '權衡選項中',
  'chat.workingStatus.retrying': '重試中',
  'chat.workingStatus.retryingIn': '{countdown} 後重試',
  'chat.workingStatus.retryingAttempt': '重試中（第 {attempt} 次）',
  'chat.workingStatus.retryingInAttempt': '{countdown} 後重試（第 {attempt} 次）',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 Ocelot',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 Ocelot 伺服器之間切換',
  ...
  'multiRun.window.description': 'Ocelot 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 Ocelot',
  'onboarding.chooser.description': '選擇你的連線方式以開始使用。',
  'onboarding.chooser.tabs.localInstall': '本地安裝',
  'onboarding.chooser.tabs.bundled': '內建',
  'onboarding.chooser.bundled.title': '使用內建 OpenCode',
  'onboarding.chooser.bundled.description': '使用 OpenChamber Desktop 內建的 OpenCode CLI。無需另行安裝。',
  'onboarding.chooser.bundled.notDetectedHint': '此建置版本未提供內建 CLI。',
  'onboarding.chooser.bundled.actions.useBundled': '使用內建',
  'onboarding.chooser.bundled.actions.starting': '啟動中…',
  'onboarding.chooser.local.actions.starting': '啟動中…',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Ocelot 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 Ocelot 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 Ocelot 設定並重新載入 OpenCode 設定。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 Ocelot 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 Ocelot 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 Ocelot。請確認位址是否指向 Ocelot 伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 Ocelot。請確認位址是否指向 Ocelot 伺服器。',
  ...
  'startup.initRecovery.description': 'Ocelot 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 Ocelot...',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 Ocelot 開啟。',
  ...
  'openChamberLogo.aria.logo': 'Ocelot 標誌',
