...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.connect.welcome.title': '连接到 Ocelot',
  ...
  'mobile.connect.password.placeholder': 'Ocelot 密码',
  ...
  'mobile.connect.scan.invalid': '该二维码不是 Ocelot 连接码。',
  ...
  'mobile.connect.error.unreachable': '无法连接到该 Ocelot 服务器。',
  ...
  'sessions.sidebar.footer.actions.aboutOcelot': '关于 Ocelot',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 Ocelot 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'terminalView.bottomDock.cdToConfigDirTitle': '打开 opencode 配置目录',
  'terminalView.bottomDock.cdToConfigDirAria': '打开 opencode 配置目录',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Ocelot 状态、OpenCode 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 Ocelot',
  ...
  'header.actions.openAppMenu': 'Ocelot 菜单',
  'header.actions.openAppMenuAria': '打开 Ocelot 菜单',
  ...
  'chat.workingStatus.composing': '撰写中',
  'chat.workingStatus.editingFile': '编辑文件中',
  'chat.workingStatus.waitingForPermission': '等待权限',
  'chat.workingStatus.usingTool': '使用 {tool} 中',
  'chat.workingStatus.tool.read': '读取文件中',
  'chat.workingStatus.tool.write': '写入文件中',
  'chat.workingStatus.tool.edit': '编辑文件中',
  'chat.workingStatus.tool.multiedit': '编辑多个文件中',
  'chat.workingStatus.tool.apply_patch': '应用补丁中',
  'chat.workingStatus.tool.bash': '运行命令中',
  'chat.workingStatus.tool.grep': '搜索内容中',
  'chat.workingStatus.tool.glob': '查找文件中',
  'chat.workingStatus.tool.list': '列出目录中',
  'chat.workingStatus.tool.task': '委派任务中',
  'chat.workingStatus.tool.webfetch': '获取 URL 中',
  'chat.workingStatus.tool.websearch': '搜索网页中',
  'chat.workingStatus.tool.codesearch': '网页代码搜索中',
  'chat.workingStatus.tool.todowrite': '更新待办中',
  'chat.workingStatus.tool.todoread': '读取待办中',
  'chat.workingStatus.tool.skill': '学习技能中',
  'chat.workingStatus.tool.question': '提问中',
  'chat.workingStatus.tool.plan_enter': '切换到规划中',
  'chat.workingStatus.tool.plan_exit': '切换到构建中',
  'chat.workingStatus.generic.working': '工作中',
  'chat.workingStatus.generic.processing': '处理中',
  'chat.workingStatus.generic.preparing': '准备中',
  'chat.workingStatus.generic.warmingUp': '预热中',
  'chat.workingStatus.generic.gearsTurning': '齿轮转动中',
  'chat.workingStatus.generic.computing': '计算中',
  'chat.workingStatus.generic.calculating': '运算中',
  'chat.workingStatus.generic.analyzing': '分析中',
  'chat.workingStatus.generic.wheelsSpinning': '车轮转动中',
  'chat.workingStatus.generic.calibrating': '校准中',
  'chat.workingStatus.generic.synthesizing': '综合中',
  'chat.workingStatus.generic.connectingDots': '连点成线中',
  'chat.workingStatus.generic.inspectingLogic': '检查逻辑中',
  'chat.workingStatus.generic.weighingOptions': '权衡选项中',
  'chat.workingStatus.retrying': '重试中',
  'chat.workingStatus.retryingIn': '{countdown} 后重试',
  'chat.workingStatus.retryingAttempt': '重试中（第 {attempt} 次）',
  'chat.workingStatus.retryingInAttempt': '{countdown} 后重试（第 {attempt} 次）',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 Ocelot',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 Ocelot 服务器之间切换',
  ...
  'multiRun.window.description': 'Ocelot 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 Ocelot',
  'onboarding.chooser.description': '选择你的连接方式以开始使用。',
  'onboarding.chooser.tabs.localInstall': '本地安装',
  'onboarding.chooser.tabs.bundled': '内置',
  'onboarding.chooser.bundled.title': '使用内置 OpenCode',
  'onboarding.chooser.bundled.description': '使用 OpenChamber Desktop 内置的 OpenCode CLI。无需单独安装。',
  'onboarding.chooser.bundled.notDetectedHint': '此构建版本未提供内置 CLI。',
  'onboarding.chooser.bundled.actions.useBundled': '使用内置',
  'onboarding.chooser.bundled.actions.starting': '启动中…',
  'onboarding.chooser.local.actions.starting': '启动中…',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Ocelot 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 Ocelot 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 Ocelot 设置并重新加载 OpenCode 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 Ocelot 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 Ocelot 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 Ocelot。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 Ocelot，但与此应用版本不兼容。请更新服务器上的 Ocelot 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 Ocelot。请确认地址是否指向 Ocelot 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 Ocelot。请确认地址是否指向 Ocelot 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 Ocelot 服务器与此应用版本不兼容。请更新服务器上的 Ocelot 后重试。',
  ...
  'startup.initRecovery.description': 'Ocelot 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'opencodeUpdate.toast.upgrading.description': '请保持 Ocelot 打开。',
  ...
  'openChamberLogo.aria.logo': 'Ocelot 标志',
