export const settingsDict = {
  ...
  'settings.window.description': 'Ocelot settings window.',
  ...
  'settings.ocelot.tunnel.title': 'Remote Tunnel',
  'settings.ocelot.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.ocelot.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.ocelot.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.ocelot.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.ocelot.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.ocelot.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.ocelot.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.ocelot.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.ocelot.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.ocelot.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.ocelot.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.ocelot.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.ocelot.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.ocelot.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.ocelot.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.ocelot.tunnel.notAvailable.dependencyNotFound': '{dependency} was not found.',
  'settings.ocelot.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.ocelot.tunnel.field.provider': 'Provider',
  'settings.ocelot.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.ocelot.tunnel.field.tunnelType': 'Tunnel type',
  'settings.ocelot.tunnel.field.connectLinkTtl': 'Connect link TTL',
  'settings.ocelot.tunnel.field.tunnelSessionTtl': 'Tunnel session TTL',
  'settings.ocelot.tunnel.field.hostnameLabel': 'Hostname:',
  'settings.ocelot.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.ocelot.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.ocelot.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.ocelot.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.ocelot.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.ocelot.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.ocelot.tunnel.field.configurationFile': 'Configuration file',
  'settings.ocelot.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.ocelot.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.ocelot.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.ocelot.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.ocelot.tunnel.field.connectLink': 'Connect link',
  'settings.ocelot.tunnel.field.expires': 'Expires',
  'settings.ocelot.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.ocelot.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.ocelot.tunnel.actions.saveToken': 'Save token',
  'settings.ocelot.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.ocelot.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.ocelot.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.ocelot.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.ocelot.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.ocelot.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.ocelot.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.ocelot.tunnel.actions.stopping': 'Stopping...',
  'settings.ocelot.tunnel.actions.newConnectLink': 'New connect link',
  'settings.ocelot.tunnel.actions.copied': 'Copied',
  'settings.ocelot.tunnel.actions.retry': 'Retry',
  'settings.ocelot.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.ocelot.tunnel.option.mode.quick.label': 'Quick',
  'settings.ocelot.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and uptime is not guaranteed.',
  'settings.ocelot.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.ocelot.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.ocelot.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.ocelot.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.ocelot.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.ocelot.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  ...
  'settings.ocelot.tunnel.state.loading': 'Loading',
  'settings.ocelot.tunnel.state.expired': 'Expired',
  'settings.ocelot.tunnel.state.revoked': 'Revoked',
  'settings.ocelot.tunnel.state.inactive': 'Inactive',
  'settings.ocelot.tunnel.state.noExpiry': 'No expiry',
  'settings.ocelot.tunnel.state.never': 'Never',
  'settings.ocelot.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.ocelot.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.ocelot.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.ocelot.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.ocelot.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.ocelot.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/ocelot/cloudflare-managed-remote-tunnels.json.',
  'settings.ocelot.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.ocelot.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.ocelot.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.ocelot.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.ocelot.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.ocelot.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.ocelot.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.ocelot.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.ocelot.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.ocelot.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.ocelot.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.ocelot.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.ocelot.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.ocelot.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.ocelot.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.ocelot.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.ocelot.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.ocelot.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.ocelot.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.ocelot.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.ocelot.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.ocelot.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.ocelot.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.ocelot.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.ocelot.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.ocelot.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  'settings.ocelot.tunnel.toast.passwordSaved': 'Tunnel password saved',
  'settings.ocelot.tunnel.toast.savePasswordFailed': 'Failed to save tunnel password',
  'settings.ocelot.tunnel.toast.saveAutoStartFailed': 'Failed to save tunnel auto-start setting',
  'settings.ocelot.tunnel.field.tunnelPassword': 'Use password authentication',
  'settings.ocelot.tunnel.field.tunnelPasswordHint': 'Visitors enter this password instead of using a one-time connect link.',
  'settings.ocelot.tunnel.field.tunnelPasswordPlaceholder': 'Set a tunnel password',
  'settings.ocelot.tunnel.field.tunnelPasswordAria': 'Tunnel password',
  'settings.ocelot.tunnel.field.tunnelAutoStart': 'Auto-start tunnel on launch',
  'settings.ocelot.tunnel.field.tunnelAutoStartHint': 'Automatically start the tunnel when the app launches if it was active last time.',
  ...
  'settings.remoteInstances.direct.title': 'Other Ocelot servers',
  'settings.remoteInstances.direct.description': 'Add another Ocelot server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another Ocelot server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid Ocelot connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so Ocelot Desktop can connect to this server.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether Ocelot should start the server for you, or connect to one that is already running.',
  ...
  'settings.ocelot.about.title': 'About Ocelot',
  'settings.ocelot.about.field.version': 'Version',
  'settings.ocelot.about.field.openCodeVersion': 'OpenCode version',
  'settings.ocelot.about.state.checking': 'Checking...',
  'settings.ocelot.about.state.upToDate': 'Up to date',
  'settings.ocelot.about.state.unknown': 'unknown',
  'settings.ocelot.about.actions.checkUpdates': 'Check updates',
  'settings.ocelot.about.actions.update': 'Update',
  'settings.ocelot.about.actions.updateToVersion': 'Update to {version}',
  'settings.ocelot.about.actions.checkForUpdates': 'Check for updates',
  'settings.ocelot.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. Ocelot will scan it for folders containing',
  ...
  'settings.ocelot.passkeys.title': 'Passkeys',
  'settings.ocelot.passkeys.field.currentDevice': 'Current device',
  'settings.ocelot.passkeys.actions.add': 'Add passkey',
  'settings.ocelot.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.ocelot.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.ocelot.passkeys.actions.signingOut': 'Signing out…',
  'settings.ocelot.passkeys.actions.removing': 'Removing…',
  'settings.ocelot.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.ocelot.passkeys.state.loading': 'Loading passkeys…',
  'settings.ocelot.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.ocelot.passkeys.item.lastUsed': 'Last used {time}',
  'settings.ocelot.passkeys.item.added': 'Added {time}',
  'settings.ocelot.passkeys.time.neverUsed': 'Never used',
  'settings.ocelot.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.ocelot.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.ocelot.passkeys.toast.added': 'Passkey added',
  'settings.ocelot.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.ocelot.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.ocelot.passkeys.toast.removed': 'Passkey removed',
  'settings.ocelot.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.ocelot.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.ocelot.sessionRetention.title': 'Session Retention',
  'settings.ocelot.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.ocelot.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.ocelot.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.ocelot.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.ocelot.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.ocelot.sessionRetention.field.days': 'days',
  'settings.ocelot.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.ocelot.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.ocelot.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.ocelot.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.ocelot.sessionRetention.action.archive': 'Archive',
  'settings.ocelot.sessionRetention.action.delete': 'Delete',
  'settings.ocelot.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.ocelot.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.ocelot.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.ocelot.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.ocelot.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.ocelot.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.ocelot.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.ocelot.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.ocelot.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.ocelot.desktopNetwork.title': 'Desktop Network Access',
  'settings.ocelot.desktopNetwork.field.launchAtLoginAria': 'Start Ocelot at login',
  'settings.ocelot.desktopNetwork.field.launchAtLogin': 'Start Ocelot when you log in',
  'settings.ocelot.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Click the Dock icon to open it.',
  'settings.ocelot.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while Ocelot is running',
  'settings.ocelot.desktopNetwork.field.keepAwake': 'Keep computer awake while Ocelot is running',
  'settings.ocelot.desktopNetwork.field.keepAwakeDescription': 'Prevents system sleep so phones can keep reaching this app. The screen can still turn off.',
  'settings.ocelot.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.ocelot.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.ocelot.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.ocelot.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.ocelot.desktopNetwork.field.passwordRequiredWarning': 'LAN access requires a Desktop UI Password. Until one is set, the desktop app starts local-only.',
  'settings.ocelot.desktopPassword.field.password': 'Desktop UI Password',
  'settings.ocelot.desktopPassword.field.passwordPlaceholder': 'No password required',
  'settings.ocelot.desktopPassword.field.passwordDescription': 'Ocelot asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  'settings.ocelot.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.ocelot.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.ocelot.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.ocelot.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.ocelot.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.ocelot.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.ocelot.desktopNetwork.error.launchAtLoginUnsupported': 'Launch at login is not supported on this system',
  'settings.ocelot.desktopNetwork.error.launchAtLoginSaveFailed': 'Failed to update launch at login setting',
  'settings.ocelot.desktopNetwork.error.keepAwakeUnsupported': 'Preventing sleep is not supported on this system',
  'settings.ocelot.desktopNetwork.error.keepAwakeSaveFailed': 'Failed to update keep awake setting',
  'settings.ocelot.opencodeCli.title': 'OpenCode CLI',
  'settings.ocelot.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.ocelot.opencodeCli.tooltipSuffix': 'binary.',
  'settings.ocelot.opencodeCli.field.binaryPath': 'OpenCode Binary Path',
  'settings.ocelot.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.ocelot.opencodeCli.field.showUpdateNotifications': 'Show OpenCode update notifications',
  'settings.ocelot.opencodeCli.field.showUpdateNotificationsAria': 'Show OpenCode update notifications',
  'settings.ocelot.opencodeCli.actions.browseAria': 'Browse for OpenCode binary path',
  'settings.ocelot.opencodeCli.actions.browse': 'Browse',
  'settings.ocelot.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.ocelot.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCode…',
  'settings.ocelot.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.ocelot.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.ocelot.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.ocelot.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.ocelot.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.ocelot.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.ocelot.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.ocelot.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.ocelot.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.ocelot.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
  'settings.ocelot.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. It is still saved.',
  'settings.ocelot.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.ocelot.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.ocelot.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.ocelot.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.ocelot.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.ocelot.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.ocelot.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.ocelot.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle right sidebar',
  'settings.ocelot.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open right sidebar Git tab',
  'settings.ocelot.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open right sidebar Files tab',
  'settings.ocelot.keyboardShortcuts.action.cycle_right_sidebar_tab.label': 'Cycle right sidebar tab',
  'settings.ocelot.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.ocelot.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.ocelot.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.ocelot.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.ocelot.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.ocelot.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.ocelot.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.ocelot.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.ocelot.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.ocelot.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.ocelot.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.ocelot.keyboardShortcuts.action.open_model_selector.label': 'Open model selector',
  'settings.ocelot.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.ocelot.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open Ocelot there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'Ocelot on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how Ocelot should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote Ocelot server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote Ocelot UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How Ocelot should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingOcelot': 'Installing Ocelot',
  'settings.remoteInstances.page.phase.updatingOcelot': 'Updating Ocelot',
  ...
  'settings.ocelot.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.ocelot.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.ocelot.worktrees.setup.title': 'Setup commands',
  'settings.ocelot.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.ocelot.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.ocelot.worktrees.setup.loading': 'Loading...',
  'settings.ocelot.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.ocelot.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.ocelot.worktrees.setup.addCommand': 'Add command',
  'settings.ocelot.worktrees.setup.waitForCommands': 'Wait for setup commands before creating or sending a session',
  'settings.ocelot.worktrees.setup.waitForCommandsAria': 'Wait for Worktree setup commands before creating or sending a session',
  'settings.ocelot.worktrees.list.title': 'Existing worktrees',
  'settings.ocelot.worktrees.list.tooltip': 'Worktrees live outside the repo (OpenCode-managed). Deleting a worktree also removes linked sessions.',
  'settings.ocelot.worktrees.list.loading': 'Loading worktrees...',
  'settings.ocelot.worktrees.list.empty': 'No worktrees found for this project',
  'settings.ocelot.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.ocelot.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by Ocelot.',
  'settings.providers.page.auth.apiKeyPlaceholder': 'sk-...',
  'settings.providers.page.auth.airouterNoKeyHint': 'AI Router is a local proxy managed by Ocelot. API keys are configured per-route in AI Router settings, so no key is needed here.',
  'settings.providers.page.auth.airouterConnect': 'Connect',
  ...
  'settings.providers.page.toast.providerConnected': 'Provider connected',
  'settings.providers.page.toast.providerConnectFailed': 'Failed to connect provider',
  ...
  'settings.ocelot.defaults.field.defaultAgent': 'Default Agent',
  'settings.ocelot.defaults.field.defaultModel': 'Default Model',
  'settings.ocelot.defaults.field.defaultThinking': 'Default Thinking',
  'settings.ocelot.defaults.field.openFilesPreview': 'Open files in preview mode',
  'settings.ocelot.defaults.field.openFilesPreviewAria': 'Open files in preview mode',
  'settings.ocelot.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.ocelot.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.ocelot.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.ocelot.defaults.option.default': 'Default',
  'settings.ocelot.defaults.option.defaultLowercase': 'default',
  'settings.ocelot.defaults.summaryOpenCodeDefault': 'OpenCode agent default',
  'settings.ocelot.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.ocelot.defaults.title': 'Session Defaults',
  'settings.ocelot.git.changesViewAria': 'Git changes view mode',
  'settings.ocelot.git.changesViewTitle': 'Changes View',
  'settings.ocelot.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.ocelot.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.ocelot.git.option.flatList': 'Flat List',
  'settings.ocelot.git.option.treeView': 'Tree View',
  'settings.ocelot.git.optionAria': 'Git changes view mode: {option}',
  'settings.ocelot.git.showGitignored': 'Display Gitignored Files',
  'settings.ocelot.git.showGitignoredAria': 'Display gitignored files',
  'settings.ocelot.git.title': 'Git Preferences',
  'settings.ocelot.defaults.smallModel.description': 'A cheap model for quick utility tasks like short recaps and summaries.',
  'settings.ocelot.defaults.smallModel.overrideModel': 'Override model',
  'settings.ocelot.defaults.smallModel.title': 'Small Model',
  'settings.ocelot.defaults.smallModel.useDefault': 'Use default small model',
  'settings.ocelot.defaults.smallModel.useDefaultAria': 'Use default small model',
  ...
  'settings.github.page.flow.title': 'Authorize Ocelot',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if Ocelot auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from Ocelot.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the Ocelot server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the Ocelot server (Kokoro, English). The model downloads automatically; no API key needed.',
  ...
  'settings.ocelot.visual.actions.reloadThemes': 'Reload themes',
  'settings.ocelot.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.ocelot.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.ocelot.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.ocelot.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.ocelot.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.ocelot.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.ocelot.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.ocelot.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.ocelot.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.ocelot.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.ocelot.visual.actions.restarting': 'Restarting…',
  'settings.ocelot.visual.actions.saveAndRestart': 'Save & restart',
  'settings.ocelot.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.ocelot.visual.field.bash': 'Bash',
  'settings.ocelot.visual.field.codeFont': 'Code Font',
  'settings.ocelot.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.ocelot.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.ocelot.visual.field.collapsibleUserMessages': 'Collapse Long User Messages',
  'settings.ocelot.visual.field.collapsibleUserMessagesAria': 'Collapse long user messages',
  'settings.ocelot.visual.field.darkTheme': 'Dark Theme',
  'settings.ocelot.visual.field.diffLayoutAria': 'Diff layout: {option}',
  'settings.ocelot.visual.field.dockBadge': 'Dock badge',
  'settings.ocelot.visual.field.dockBadgeHint': 'Show a count of chats with unseen activity on the macOS dock icon.',
  'settings.ocelot.visual.field.editTools': 'Edit tools',
  'settings.ocelot.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.ocelot.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  ...
  'settings.ocelot.visual.field.fileEditorKeymap': 'File editor keymap',
  'settings.ocelot.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.ocelot.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.ocelot.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.ocelot.visual.field.installAppName': 'Install App Name',
  'settings.ocelot.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.ocelot.visual.field.installOrientation': 'Install Orientation',
  'settings.ocelot.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.ocelot.visual.field.interfaceFont': 'Interface Font',
  'settings.ocelot.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.ocelot.visual.field.lightTheme': 'Light Theme',
  'settings.ocelot.visual.field.macVibrancy': 'Window transparency',
  'settings.ocelot.visual.field.macVibrancyHint': 'Use the native macOS blur (vibrancy) behind the sidebar. Turn off for fully solid, opaque surfaces.',
  'settings.ocelot.visual.field.mermaidRenderingAria': 'Mermaid rendering: {option}',
  'settings.ocelot.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.ocelot.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.ocelot.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.ocelot.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.ocelot.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.ocelot.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.ocelot.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.ocelot.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.ocelot.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.ocelot.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.ocelot.visual.field.selectCodeFontAria': 'Select code font',
  'settings.ocelot.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.ocelot.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.ocelot.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.ocelot.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.ocelot.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.ocelot.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.ocelot.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.ocelot.visual.field.selectWeekStartAria': 'Select week start',
  'settings.ocelot.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.ocelot.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.ocelot.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.ocelot.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.ocelot.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.ocelot.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.ocelot.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.ocelot.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.ocelot.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.ocelot.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.ocelot.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.ocelot.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.ocelot.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.ocelot.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.ocelot.visual.field.showTurnChangedFiles': 'Show Changed Files for Completed Turns',
  'settings.ocelot.visual.field.showTurnChangedFilesAria': 'Show changed files for completed turns',
  'settings.ocelot.visual.field.spacingDensity': 'Spacing Density',
  'settings.ocelot.visual.field.stickyUserHeader': 'Sticky User Header',
  'settings.ocelot.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.ocelot.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.ocelot.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.ocelot.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.ocelot.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.ocelot.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.ocelot.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/ocelot/themes/',
  'settings.ocelot.visual.field.timeFormat': 'Time Format',
  'settings.ocelot.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  'settings.ocelot.visual.field.weekStartsOn': 'Week Starts On',
  'settings.ocelot.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.ocelot.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.ocelot.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.ocelot.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.ocelot.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.ocelot.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.ocelot.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.ocelot.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.ocelot.visual.option.fileEditorKeymap.default': 'Default',
  'settings.ocelot.visual.option.fileEditorKeymap.vim': 'Vim',
  'settings.ocelot.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.ocelot.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.ocelot.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.ocelot.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.ocelot.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.ocelot.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.ocelot.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.ocelot.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.ocelot.visual.option.mobileLayout.default': 'Old',
  'settings.ocelot.visual.option.mobileLayout.new': 'New',
  'settings.ocelot.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.ocelot.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.ocelot.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.ocelot.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.ocelot.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.ocelot.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.ocelot.visual.option.themeMode.dark': 'Dark',
  'settings.ocelot.visual.option.themeMode.light': 'Light',
  'settings.ocelot.visual.option.themeMode.system': 'System',
  'settings.ocelot.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.ocelot.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.ocelot.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'settings.ocelot.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.ocelot.visual.section.activityDefault': 'Activity Default',
  'settings.ocelot.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.ocelot.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.ocelot.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.ocelot.visual.section.colorMode': 'Color Mode',
  'settings.ocelot.visual.section.diffLayout': 'Diff Layout',
  'settings.ocelot.visual.section.diffLayoutAria': 'Diff layout',
  'settings.ocelot.visual.section.localization': 'Localization',
  'settings.ocelot.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.ocelot.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.ocelot.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.ocelot.visual.section.mobileLayout': 'Mobile Layout',
  'settings.ocelot.visual.section.navigation': 'Navigation',
  'settings.ocelot.visual.section.privacy': 'Privacy',
  'settings.ocelot.visual.section.showToolsOpenedByDefault': 'Show tools opened by default:',
  'settings.ocelot.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.ocelot.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.ocelot.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.ocelot.visual.field.sessionRecap': 'Generate Session Recap',
  'settings.ocelot.visual.field.sessionRecapAria': 'Generate a recap after the agent finishes',
  'settings.ocelot.visual.field.sessionSuggestion': 'Generate Next User Message Suggestion',
  'settings.ocelot.visual.field.sessionSuggestionAria': 'Generate a suggested next user message after the agent finishes',
  'settings.voice.page.field.ttsInputModeSummarized': 'summarized',
  'chat.message.userText.collapseAria': 'Collapse user message',
  'settings.ocelot.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.ocelot.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.ocelot.visual.option.chatRenderMode.live.label': 'Live',
  'settings.ocelot.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.ocelot.visual.option.messageTransport.auto.label': 'Auto',
  'settings.ocelot.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.ocelot.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.ocelot.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.ocelot.visual.option.messageTransport.sse.label': 'SSE',
  'settings.ocelot.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.ocelot.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.ocelot.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.ocelot.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.ocelot.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.ocelot.visual.option.timeFormat.auto.label': 'Auto',
  'settings.ocelot.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.ocelot.visual.option.timeFormat.24h.label': '24-hour',
  'settings.ocelot.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.ocelot.visual.option.timeFormat.12h.label': '12-hour',
  'settings.ocelot.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.ocelot.visual.option.weekStart.auto.label': 'Auto',
  'settings.ocelot.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.ocelot.visual.option.weekStart.monday.label': 'Monday',
  'settings.ocelot.visual.option.weekStart.sunday.label': 'Sunday',
  ...
  'settings.airouter.page.description': 'Route model requests through upstream providers with fallback support.',
  'settings.airouter.page.field.enable': 'Enable AI Router',
  'settings.airouter.page.field.enableAria': 'Enable AI Router',
  'settings.airouter.page.hint.enable': 'When enabled, OpenCode will route requests through the configured upstream providers instead of direct provider access.',
  'settings.airouter.page.section.routes': 'Routes',
  'settings.airouter.page.tooltip.routes': 'Each route maps a model ID to an upstream endpoint with custom params, retry, timeout, and fallback chain.',
  'settings.airouter.page.tooltip.fields': 'Model Name: display name in OpenCode. Model ID: identifier used by OpenCode to request this model. Original Model ID: the model parameter sent to the upstream provider; if empty, defaults to Model ID.',
  'settings.airouter.page.section.dns': 'DNS Override',
  'settings.airouter.page.field.dnsEnable': 'Use custom DNS servers',
  'settings.airouter.page.field.dnsEnableAria': 'Use custom DNS servers',
  'settings.airouter.page.field.dnsServers': 'DNS Servers (comma-separated)',
  'settings.airouter.page.field.dnsTimeout': 'DNS Timeout (ms)',
  'settings.airouter.page.field.modelName': 'Model Name',
  'settings.airouter.page.field.modelNamePlaceholder': 'e.g. GPT-4o',
  'settings.airouter.page.field.modelId': 'Model ID',
  'settings.airouter.page.field.modelIdPlaceholder': 'e.g. gpt-4o',
  ...
  'settings.airouter.page.field.modelIdOriginalPlaceholder': 'e.g. gpt-4o-2024-08-06',
  'settings.airouter.page.hint.modelIdOriginal': 'If empty, Model ID is used as the upstream model parameter.',
  'settings.airouter.page.field.timeout': 'Timeout (ms)',
  'settings.airouter.page.hint.timeout': '0 = no timeout. Request aborts after this duration.',
  'settings.airouter.page.field.maxRetries': 'Max Retries',
  'settings.airouter.page.hint.maxRetries': 'Number of retry attempts before failing over.',
  'settings.airouter.page.field.routeEnabled': 'Enable this route',
  'settings.airouter.page.section.params': 'Custom Parameters',
  'settings.airouter.page.tooltip.params': 'Custom parameters merged into the request body sent to the upstream provider (e.g. enable_thinking, temperature).',
  'settings.airouter.page.field.paramName': 'Parameter name',
  'settings.airouter.page.field.paramValue': 'Value',
  'settings.airouter.page.hint.paramBoolean': 'For boolean type, use "true" or "false".',
  'settings.airouter.page.section.newRoute': 'New Route',
  'settings.airouter.page.section.editRoute': 'Edit Route',
  'settings.airouter.page.empty.title': 'No Routes Yet',
  'settings.airouter.page.empty.description': 'Add a route to start routing model requests through upstream providers.',
  'settings.airouter.page.section.fallback': 'Fallback Routes',
  'settings.airouter.page.hint.fallbackEmpty': 'Add more routes to enable fallback.',
  'settings.airouter.page.section.logs': 'Runtime Logs',
  'settings.airouter.page.field.autoRefresh': 'Auto-refresh',
  'settings.airouter.page.actions.addRoute': 'Add Route',
  'settings.airouter.page.actions.removeRoute': 'Remove route',
  'settings.airouter.page.actions.removeParam': 'Remove parameter',
  'settings.airouter.page.actions.clearLogs': 'Clear',
  'settings.airouter.page.empty.logs': 'No logs yet.',
  'settings.airouter.page.toast.saved': 'AI Router configuration saved. OpenCode provider updated.',
