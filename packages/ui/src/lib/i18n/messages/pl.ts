...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj Ocelot, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'Ocelot został zainstalowany',
  ...
  'mobile.connect.welcome.title': 'Połącz z Ocelot',
  ...
  'mobile.connect.password.placeholder': 'Hasło Ocelot',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia Ocelot.',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem Ocelot.',
  ...
  'sessions.sidebar.footer.actions.aboutOcelot': 'O Ocelot',
  ...
  'chat.workingStatus.thinking': 'Myślenie',
  'chat.workingStatus.composing': 'Tworzenie',
  'chat.workingStatus.editingFile': 'Edytowanie pliku',
  'chat.workingStatus.waitingForPermission': 'Oczekiwanie na zgodę',
  'chat.workingStatus.usingTool': 'Użycie {tool}',
  'chat.workingStatus.tool.read': 'Odczytywanie pliku',
  'chat.workingStatus.tool.write': 'Zapisywanie pliku',
  'chat.workingStatus.tool.edit': 'Edytowanie pliku',
  'chat.workingStatus.tool.multiedit': 'Edytowanie plików',
  'chat.workingStatus.tool.apply_patch': 'Stosowanie łatki',
  'chat.workingStatus.tool.bash': 'Wykonywanie polecenia',
  'chat.workingStatus.tool.grep': 'Przeszukiwanie treści',
  'chat.workingStatus.tool.glob': 'Wyszukiwanie plików',
  'chat.workingStatus.tool.list': 'Wyświetlanie katalogu',
  'chat.workingStatus.tool.task': 'Delegowanie zadania',
  'chat.workingStatus.tool.webfetch': 'Pobieranie URL',
  'chat.workingStatus.tool.websearch': 'Przeszukiwanie sieci',
  'chat.workingStatus.tool.codesearch': 'Wyszukiwanie kodu w sieci',
  'chat.workingStatus.tool.todowrite': 'Aktualizowanie zadań',
  'chat.workingStatus.tool.todoread': 'Odczytywanie zadań',
  'chat.workingStatus.tool.skill': 'Uczenie się umiejętności',
  'chat.workingStatus.tool.question': 'Zadawanie pytania',
  'chat.workingStatus.tool.plan_enter': 'Przełączanie na planowanie',
  'chat.workingStatus.tool.plan_exit': 'Przełączanie na budowanie',
  'chat.workingStatus.generic.working': 'Praca',
  'chat.workingStatus.generic.processing': 'Przetwarzanie',
  'chat.workingStatus.generic.preparing': 'Przygotowywanie',
  'chat.workingStatus.generic.warmingUp': 'Rozgrzewanie',
  'chat.workingStatus.generic.gearsTurning': 'Tryby w ruchu',
  'chat.workingStatus.generic.computing': 'Obliczanie',
  'chat.workingStatus.generic.calculating': 'Kalkulowanie',
  'chat.workingStatus.generic.analyzing': 'Analizowanie',
  'chat.workingStatus.generic.wheelsSpinning': 'Koła się kręcą',
  'chat.workingStatus.generic.calibrating': 'Kalibrowanie',
  'chat.workingStatus.generic.synthesizing': 'Syntezowanie',
  'chat.workingStatus.generic.connectingDots': 'Łączenie kropek',
  'chat.workingStatus.generic.inspectingLogic': 'Sprawdzanie logiki',
  'chat.workingStatus.generic.weighingOptions': 'Ważenie opcji',
  'chat.workingStatus.retrying': 'Ponawianie',
  'chat.workingStatus.retryingIn': 'Ponowienie za {countdown}',
  'chat.workingStatus.retryingAttempt': 'Ponawianie (próba {attempt})',
  'chat.workingStatus.retryingInAttempt': 'Ponowienie za {countdown} (próba {attempt})',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia Ocelot.',
  ...
  'onboarding.chooser.title': 'Witaj w Ocelot',
  ...
  'onboarding.chooser.tabs.bundled': 'Wbudowany',
  'onboarding.chooser.bundled.title': 'Użyj wbudowanego OpenCode',
  'onboarding.chooser.bundled.description': 'Użyj CLI OpenCode wbudowanego w OpenChamber Desktop. Nie wymaga oddzielnej instalacji.',
  'onboarding.chooser.bundled.notDetectedHint': 'Wbudowane CLI nie jest dostępne w tej kompilacji.',
  'onboarding.chooser.bundled.actions.useBundled': 'Użyj wbudowanego',
  'onboarding.chooser.bundled.actions.starting': 'Uruchamianie…',
  'onboarding.chooser.local.actions.starting': 'Uruchamianie…',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli Ocelot nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień Ocelot i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera Ocelot aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer Ocelot, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji Ocelot. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia Ocelot, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj Ocelot na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim Ocelot. Zweryfikuj czy adres wskazuje na serwer Ocelot.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia Ocelot. Zweryfikuj czy adres wskazuje na serwer Ocelot.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer Ocelot pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj Ocelot na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'Ocelot nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan Ocelot, kondycję OpenCode, katalogi i projekty.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja Ocelot {version}',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do Ocelot — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami Ocelot',
  ...
  'header.actions.openAppMenu': 'Menu Ocelot',
  'header.actions.openAppMenuAria': 'Otwórz menu Ocelot',
  ...
  'header.services.shutdownDev': 'Zatrzymaj Ocelot',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po Ocelot.',
  ...
  'openChamberLogo.aria.logo': 'Logo Ocelot',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj Ocelot',
  ...
  'terminalView.bottomDock.cdToConfigDirTitle': 'Go to opencode config directory',
  'terminalView.bottomDock.cdToConfigDirAria': 'Go to opencode config directory',
  ...
  'updateDialog.header.updating': 'Aktualizowanie Ocelot...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw Ocelot otwarte.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce Ocelot — zainstaluj je, aby zacząć.',
  ...
  'settings.ocelot.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  ...
  'settings.ocelot.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.ocelot.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.ocelot.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.ocelot.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.ocelot.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.ocelot.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.ocelot.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
