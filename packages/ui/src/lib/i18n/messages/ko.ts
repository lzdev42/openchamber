...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 Ocelot를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'Ocelot가 설치되었습니다',
  ...
  'mobile.connect.welcome.title': 'Ocelot에 연결',
  ...
  'mobile.connect.password.placeholder': 'Ocelot 비밀번호',
  ...
  'mobile.connect.scan.invalid': '이 QR 코드는 Ocelot 연결 코드가 아닙니다.',
  ...
  'mobile.connect.error.unreachable': '해당 Ocelot 서버에 연결할 수 없습니다.',
  ...
  'sessions.sidebar.footer.actions.aboutOcelot': 'Ocelot 정보',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 Ocelot에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'header.services.shutdownDev': 'Ocelot 종료',
  ...
  'terminalView.bottomDock.cdToConfigDirTitle': 'opencode 설정 디렉터리로 이동',
  'terminalView.bottomDock.cdToConfigDirAria': 'opencode 설정 디렉터리로 이동',
  ...
  'aboutDialog.openChamberVersionLabel': 'Ocelot 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Ocelot 상태, OpenCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 Ocelot를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'Ocelot 메뉴',
  'header.actions.openAppMenuAria': 'Ocelot 메뉴 열기',
  ...
  'chat.workingStatus.thinking': '생각 중',
  'chat.workingStatus.composing': '작성 중',
  'chat.workingStatus.editingFile': '파일 편집 중',
  'chat.workingStatus.waitingForPermission': '권한 대기 중',
  'chat.workingStatus.usingTool': '{tool} 사용 중',
  'chat.workingStatus.tool.read': '파일 읽는 중',
  'chat.workingStatus.tool.write': '파일 쓰는 중',
  'chat.workingStatus.tool.edit': '파일 편집 중',
  'chat.workingStatus.tool.multiedit': '여러 파일 편집 중',
  'chat.workingStatus.tool.apply_patch': '패치 적용 중',
  'chat.workingStatus.tool.bash': '명령 실행 중',
  'chat.workingStatus.tool.grep': '내용 검색 중',
  'chat.workingStatus.tool.glob': '파일 찾는 중',
  'chat.workingStatus.tool.list': '디렉터리 나열 중',
  'chat.workingStatus.tool.task': '작업 위임 중',
  'chat.workingStatus.tool.webfetch': 'URL 가져오는 중',
  'chat.workingStatus.tool.websearch': '웹 검색 중',
  'chat.workingStatus.tool.codesearch': '웹 코드 검색 중',
  'chat.workingStatus.tool.todowrite': '할 일 업데이트 중',
  'chat.workingStatus.tool.todoread': '할 일 읽는 중',
  'chat.workingStatus.tool.skill': '스킬 학습 중',
  'chat.workingStatus.tool.question': '질문 중',
  'chat.workingStatus.tool.plan_enter': '계획 모드로 전환 중',
  'chat.workingStatus.tool.plan_exit': '빌드 모드로 전환 중',
  'chat.workingStatus.generic.working': '작업 중',
  'chat.workingStatus.generic.processing': '처리 중',
  'chat.workingStatus.generic.preparing': '준비 중',
  'chat.workingStatus.generic.warmingUp': '워밍업 중',
  'chat.workingStatus.generic.gearsTurning': '톱니바퀴 돌아가는 중',
  'chat.workingStatus.generic.computing': '계산 중',
  'chat.workingStatus.generic.calculating': '연산 중',
  'chat.workingStatus.generic.analyzing': '분석 중',
  'chat.workingStatus.generic.wheelsSpinning': '바퀴 돌아가는 중',
  'chat.workingStatus.generic.calibrating': '보정 중',
  'chat.workingStatus.generic.synthesizing': '종합 중',
  'chat.workingStatus.generic.connectingDots': '점 잇는 중',
  'chat.workingStatus.generic.inspectingLogic': '논리 검사 중',
  'chat.workingStatus.generic.weighingOptions': '옵션 검토 중',
  'chat.workingStatus.retrying': '재시도 중',
  'chat.workingStatus.retryingIn': '{countdown} 후 재시도',
  'chat.workingStatus.retryingAttempt': '재시도 중 ({attempt}회차)',
  'chat.workingStatus.retryingInAttempt': '{countdown} 후 재시도 ({attempt}회차)',
  ...
  'sessionAuth.locked.unlockTitle': 'Ocelot 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 Ocelot 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'Ocelot 멀티런 창.',
  ...
  'onboarding.chooser.title': 'Ocelot에 오신 것을 환영합니다',
  'onboarding.chooser.description': '시작 방법을 선택하세요.',
  'onboarding.chooser.tabs.localInstall': '로컬 설치',
  'onboarding.chooser.tabs.bundled': '번들',
  'onboarding.chooser.bundled.title': '번들 OpenCode 사용',
  'onboarding.chooser.bundled.description': 'OpenChamber Desktop에 번들로 포함된 OpenCode CLI를 사용합니다. 별도 설치가 필요 없습니다.',
  'onboarding.chooser.bundled.notDetectedHint': '이 빌드에서는 번들 CLI를 사용할 수 없습니다.',
  'onboarding.chooser.bundled.actions.useBundled': '내장 버전 사용',
  'onboarding.chooser.bundled.actions.starting': '시작 중…',
  'onboarding.chooser.local.actions.starting': '시작 중…',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Ocelot가 OpenCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'OpenCode는 Ocelot의 심장입니다. 먼저 설치하고 시작하세요.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Ocelot 설정에 저장하고 OpenCode 구성을 다시 로드합니다.',
  ...
  'onboarding.remoteConnection.description': '연결할 Ocelot 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 Ocelot 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 Ocelot 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 Ocelot가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 Ocelot를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 Ocelot가 실행 중이 아닙니다. 주소가 Ocelot 서버를 가리키는지 확인하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 Ocelot가 실행 중이 아닙니다. 주소가 Ocelot 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 Ocelot 서버가 이 앱 버전과 호환되지 않습니다. 서버의 Ocelot를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'Ocelot 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'Ocelot 업데이트 중…',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Ocelot를 열어 두세요.',
  ...
  'openChamberLogo.aria.logo': 'Ocelot 로고',
