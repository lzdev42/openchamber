...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install Ocelot for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'Ocelot installed',
  ...
  'mobile.connect.welcome.title': 'Connect to Ocelot',
  ...
  'mobile.connect.password.placeholder': 'Ocelot password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an Ocelot connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that Ocelot server.',
  ...
  'sessions.sidebar.footer.actions.aboutOcelot': 'About Ocelot',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to Ocelot — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'header.services.shutdownDev': 'Stop Ocelot',
  ...
  'aboutDialog.openChamberVersionLabel': 'Ocelot version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes Ocelot state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate Ocelot efficiently',
  ...
  'header.actions.openAppMenu': 'Ocelot menu',
  'header.actions.openAppMenuAria': 'Open Ocelot menu',
  ...
  'chat.workingStatus.thinking': 'Thinking',
  'chat.workingStatus.composing': 'Composing',
  'chat.workingStatus.editingFile': 'Editing file',
  'chat.workingStatus.waitingForPermission': 'Waiting for permission',
  'chat.workingStatus.usingTool': 'Using {tool}',
  'chat.workingStatus.tool.read': 'Reading file',
  'chat.workingStatus.tool.write': 'Writing file',
  'chat.workingStatus.tool.edit': 'Editing file',
  'chat.workingStatus.tool.multiedit': 'Editing files',
  'chat.workingStatus.tool.apply_patch': 'Applying patch',
  'chat.workingStatus.tool.bash': 'Running command',
  'chat.workingStatus.tool.grep': 'Searching content',
  'chat.workingStatus.tool.glob': 'Finding files',
  'chat.workingStatus.tool.list': 'Listing directory',
  'chat.workingStatus.tool.task': 'Delegating task',
  'chat.workingStatus.tool.webfetch': 'Fetching URL',
  'chat.workingStatus.tool.websearch': 'Searching web',
  'chat.workingStatus.tool.codesearch': 'Web code search',
  'chat.workingStatus.tool.todowrite': 'Updating todos',
  'chat.workingStatus.tool.todoread': 'Reading todos',
  'chat.workingStatus.tool.skill': 'Learning skill',
  'chat.workingStatus.tool.question': 'Asking question',
  'chat.workingStatus.tool.plan_enter': 'Switching to planning',
  'chat.workingStatus.tool.plan_exit': 'Switching to building',
  'chat.workingStatus.generic.working': 'Working',
  'chat.workingStatus.generic.processing': 'Processing',
  'chat.workingStatus.generic.preparing': 'Preparing',
  'chat.workingStatus.generic.warmingUp': 'Warming up',
  'chat.workingStatus.generic.gearsTurning': 'Gears turning',
  'chat.workingStatus.generic.computing': 'Computing',
  'chat.workingStatus.generic.calculating': 'Calculating',
  'chat.workingStatus.generic.analyzing': 'Analyzing',
  'chat.workingStatus.generic.wheelsSpinning': 'Wheels spinning',
  'chat.workingStatus.generic.calibrating': 'Calibrating',
  'chat.workingStatus.generic.synthesizing': 'Synthesizing',
  'chat.workingStatus.generic.connectingDots': 'Connecting dots',
  'chat.workingStatus.generic.inspectingLogic': 'Inspecting logic',
  'chat.workingStatus.generic.weighingOptions': 'Weighing options',
  'chat.workingStatus.retrying': 'Retrying',
  'chat.workingStatus.retryingIn': 'Retrying in {countdown}',
  'chat.workingStatus.retryingAttempt': 'Retrying (attempt {attempt})',
  'chat.workingStatus.retryingInAttempt': 'Retrying in {countdown} (attempt {attempt})',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock Ocelot',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote Ocelot servers',
  ...
  'multiRun.window.description': 'Ocelot Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to Ocelot',
  ...
  'onboarding.chooser.tabs.bundled': 'Bundled',
  'onboarding.chooser.tabs.connectRemote': 'Connect Remote',
  'onboarding.chooser.bundled.title': 'Use Bundled OpenCode',
  'onboarding.chooser.bundled.description': 'Use the OpenCode CLI bundled with OpenChamber Desktop. No separate install required.',
  'onboarding.chooser.bundled.notDetectedHint': 'Bundled CLI not available in this build.',
  'onboarding.chooser.bundled.actions.useBundled': 'Use Built-in',
  'onboarding.chooser.bundled.actions.starting': 'Starting…',
  'onboarding.chooser.local.actions.starting': 'Starting…',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If Ocelot does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of Ocelot — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to Ocelot settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an Ocelot server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an Ocelot server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different Ocelot version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running Ocelot but is not compatible with this app version. Update Ocelot on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running Ocelot. Verify the address points to an Ocelot server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running Ocelot. Verify the address points to an Ocelot server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The Ocelot server at "{host}" is not compatible with this app version. Update Ocelot on the server, then try again.',
  ...
  'startup.initRecovery.description': 'Ocelot could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating Ocelot...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep Ocelot open.',
  ...
  'openChamberLogo.aria.logo': 'Ocelot logo',
